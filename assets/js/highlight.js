...
(function (global) {
  ...
  /* ----------------------------------------------------------------- sql -- */
  var SQL_KW = "SELECT|FROM|WHERE|JOIN|LEFT|RIGHT|INNER|OUTER|FULL|CROSS|NATURAL|LATERAL|ON|USING|GROUP|BY|ORDER|HAVING|LIMIT|OFFSET|FETCH|FIRST|NEXT|ONLY|TIES|INSERT|INTO|VALUES|UPDATE|SET|DELETE|TRUNCATE|MERGE|MATCHED|CREATE|TABLE|INDEX|VIEW|MATERIALIZED|REFRESH|CONCURRENTLY|ALTER|DROP|ADD|COLUMN|RENAME|TO|PRIMARY|KEY|FOREIGN|REFERENCES|UNIQUE|CHECK|NOT|NULL|NULLS|LAST|DEFAULT|GENERATED|ALWAYS|IDENTITY|SERIAL|AND|OR|IN|ANY|SOME|EXISTS|BETWEEN|LIKE|ILIKE|SIMILAR|AS|DISTINCT|CASE|WHEN|THEN|ELSE|END|WITH|RECURSIVE|UNION|INTERSECT|EXCEPT|ALL|BEGIN|COMMIT|ROLLBACK|SAVEPOINT|TRANSACTION|ISOLATION|LEVEL|READ|COMMITTED|UNCOMMITTED|REPEATABLE|SERIALIZABLE|FOR|SHARE|NOWAIT|SKIP|LOCKED|EXPLAIN|ANALYZE|VERBOSE|BUFFERS|COSTS|FORMAT|PLAN|QUERY|RETURNING|CONFLICT|DO|NOTHING|CONSTRAINT|CASCADE|ASC|DESC|IS|OVER|PARTITION|WINDOW|ROWS|RANGE|GROUPS|PRECEDING|FOLLOWING|UNBOUNDED|CURRENT|ROW|EXCLUDE|QUALIFY|GROUPING|SETS|ROLLUP|CUBE|FILTER|WITHIN|INTERVAL|TEMP|TEMPORARY|IF|FUNCTION|PROCEDURE|RETURNS|LANGUAGE|TRIGGER|BEFORE|AFTER|EACH|EXECUTE|CALL|DECLARE|TABLESAMPLE|BERNOULLI|SYSTEM|INCLUDE|PIVOT|UNPIVOT|VACUUM|COPY|GRANT|TRUE|FALSE|UNKNOWN|CLUSTER|COLLATE|ARRAY|STRUCT|CROSSTAB";
  var SQL_RULES = [
    { re: rx("--[^\\n]*"), cls: "tok-com" },
    { re: rx("/\\*[\\s\\S]*?\\*/"), cls: "tok-com" },
    { re: rx("'(?:''|[^'])*'"), cls: "tok-str" },
    { re: rx("\\b(?:" + SQL_KW + ")\\b", "i"), cls: "tok-kw" },
    { re: rx("\\b(?:COUNT|SUM|AVG|MIN|MAX|COALESCE|NULLIF|GREATEST|LEAST|NOW|CURRENT_DATE|CURRENT_TIMESTAMP|DATE_TRUNC|DATE_PART|DATE|TO_CHAR|TO_DATE|TO_TIMESTAMP|MAKE_DATE|AGE|GENERATE_SERIES|ROW_NUMBER|RANK|DENSE_RANK|PERCENT_RANK|CUME_DIST|NTILE|LAG|LEAD|FIRST_VALUE|LAST_VALUE|NTH_VALUE|ARRAY_AGG|STRING_AGG|LISTAGG|GROUP_CONCAT|JSONB_AGG|JSON_AGG|JSONB_BUILD_OBJECT|JSONB_ARRAY_ELEMENTS|JSONB_EACH|JSONB_PATH_QUERY|JSONB_EXTRACT_PATH|JSON_EXTRACT|JSON_VALUE|JSON_QUERY|PERCENTILE_CONT|PERCENTILE_DISC|MODE|STDDEV|STDDEV_SAMP|VARIANCE|VAR_SAMP|CORR|COVAR_POP|BOOL_AND|BOOL_OR|EVERY|UPPER|LOWER|INITCAP|TRIM|LTRIM|RTRIM|LENGTH|CHAR_LENGTH|SUBSTRING|SUBSTR|REPLACE|REGEXP_REPLACE|REGEXP_MATCHES|SPLIT_PART|POSITION|STRPOS|CONCAT|CONCAT_WS|LPAD|RPAD|REPEAT|REVERSE|MD5|HASHTEXT|HASH|RANDOM|ROUND|FLOOR|CEIL|CEILING|ABS|POWER|SQRT|LN|LOG|EXP|SIGN|TRUNC|WIDTH_BUCKET|ARRAY_LENGTH|CARDINALITY|ARRAY_POSITION|UNNEST|EXTRACT|CAST|TYPEOF|PG_TYPEOF|IFNULL|NVL|ISNULL|IIF|STRFTIME|DATEDIFF|DATEADD|TIMESTAMPDIFF|TXID_CURRENT|PG_SLEEP|GEN_RANDOM_UUID|SETSEED)\\b", "i"), cls: "tok-bi" },
