...
(function (global) {
  ...
  var R = {
    ...
    /* Display maths. The TeX is emitted between \[ \] as text — note the
       doubled backslashes: in a JS string '\[' is just '[', so writing the
       delimiter singly dropped it and KaTeX never fired; the lesson page
