  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     ...
     "text": "Stratified KFold: 0.9467 ± 0.0267"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Train sizes: [ 119  389  658  928 1198]\nTrain scores: [0.99439776 0.9982862  0.99746707 0.99820402 0.9966611 ]\nVal scores: [0.84195882 0.90539789 0.94212577 0.95715081 0.96994992]"
    }
   ],
   "kind": "program"
  },
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Before: {np.int64(0): np.int64(897), np.int64(1): np.int64(103)}\nAfter:  {np.int64(0): np.int64(897), np.int64(1): np.int64(897)}"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Adjusted Rand Index: 1.0000"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "BIC: 2418.11, AIC: 2355.15\nSample probs: [5.79506157e-67 1.00000000e+00 1.35999675e-60]"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Original shape: (1797, 64)\nt-SNE shape: (1797, 2)\nSample 2D coords: [[ -2.8414028 -52.94057  ]\n [ 10.141024   12.16793  ]\n [-14.144702   18.76169  ]]"
    }
   ],
   "kind": "program"
  },
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Feature 2: 0.2500 ± 0.0764\nFeature 3: 0.2200 ± 0.0562\nFeature 1: 0.0000 ± 0.0000\nFeature 0: 0.0000 ± 0.0000"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Stacking CV: 0.9667 ± 0.0211"
    }
   ],
   "kind": "program"
  },
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "AdaBoost CV: 0.9533 ± 0.0340"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Best params: {'max_depth': 8, 'min_samples_split': 16, 'n_estimators': 156}\nBest score: 0.9667"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Shape: (4, 4)\n[[-1.34164079 -1.26491106  0.          1.        ]\n [-0.4472136  -0.63245553  1.          0.        ]\n [ 0.4472136   0.63245553  0.          1.        ]\n [ 1.34164079  1.26491106  1.          0.        ]]"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Coefficients: bias=5.06, w=[ 2.96116836  1.97501822 -1.05379666]"
    }
   ],
   "kind": "program"
  },
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Best split: Feature 2, Threshold 1.90\nGini before: 0.6667"
    }
   ],
   "kind": "program"
  },
  ...
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Categories: ['A' 'B' 'A' 'C' 'B' 'A' 'C' 'B']\nEncoded: [0.66666667 0.33333333 0.66666667 0.5        0.33333333 0.66666667\n 0.5        0.33333333]"
    }
   ],
   "kind": "program"
  },
  {
   ...
   "body": [
    ...
    },
    {
     "t": "out",
     "label": "Output when run",
     "text": "Best params: {'n_estimators': 193, 'max_depth': 6}\nBest score: 0.9667"
    }
   ],
   "kind": "program"
  },
