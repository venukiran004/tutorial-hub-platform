...
#              (half-widths 24.2 / 20.1 / 18.4 / 20.0 for blocks 1-7 / 8-14 / 15-21 / 22-28)`,
    ...
    { t: "callout", kind: "insight", title: "Notice what actually moved the number", body: [{ t: "p", text: "From the baseline to a decent classical model (ETS) bought 1.2 points of WAPE. Adding the calendar as regressors bought 3.2 more — the largest step in the whole pipeline, and it came from knowing the promotion dates, not from a better algorithm. The ML route, with the same calendar, landed between the two. The backtest, the gap, the metric and the availability rule are what made those numbers visible and comparable; the model class was the smallest decision." }] },
