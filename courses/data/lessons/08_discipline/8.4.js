...
EC.receiveLesson({
  ...
  <g stroke-width="1">
    ...
    <rect x="456" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="488" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="520" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="552" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/>
    ...
    <rect x="712" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="744" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="776" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="808" y="176" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/>
  </g>
  <g class="s-sub" text-anchor="middle">
    <text x="262" y="225">A</text><text x="390" y="225">B</text><text x="518" y="225" style="fill:var(--acc);font-weight:600">C</text><text x="646" y="225">D</text><text x="774" y="225" style="fill:var(--acc);font-weight:600">E</text>
  </g>
  ...
  <g stroke-width="1">
    ...
    <rect x="712" y="246" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="744" y="246" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="776" y="246" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/><rect x="808" y="246" width="28" height="28" rx="4" style="fill:var(--acc);fill-opacity:.6"/>
  </g>
  ...
  <g class="s-sub">
    ...
    <rect x="690" y="306" width="14" height="14" rx="3" style="fill:var(--acc);fill-opacity:.6"/><text x="710" y="318">test</text>
...
# sliding:   honest and recent; the window length is a hyperparameter, tuned on earlier folds`,
  ...
  <g stroke-width="1">
    ...
    <rect x="670" y="54" width="150" height="34" rx="5" style="fill:var(--acc);fill-opacity:.6"/>
  </g>
