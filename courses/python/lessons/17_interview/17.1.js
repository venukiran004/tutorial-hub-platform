...
EC.receiveLesson({
 "id": "17.1",
 "lede": "**6 interview questions on strings**, with the answers folded away. Say your answer out loud first — recognising an answer and being able to give one are different skills, and only the second survives a follow-up question.",
 "objectives": [
  "Answer 6 questions on strings without prompting",
