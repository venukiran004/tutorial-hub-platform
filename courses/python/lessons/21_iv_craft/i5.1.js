/* ============================================================================
   INTERVIEW: CRAFT & TOOLING i5.1 — Best Practices
   ----------------------------------------------------------------------------
...
EC.receiveLesson({
 "id": "i5.1",
 "lede": "**34 interview questions on best practices**, with the answers folded away. Say your answer out loud first — recognising an answer and being able to give one are different skills, and only the second survives a follow-up.",
 "objectives": [
  "Answer 34 questions on best practices without prompting",
